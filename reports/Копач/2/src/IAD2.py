...
# Создание модели с явным определением входного слоя
...
history_2d = autoencoder_2d.fit(
    X_train, X_train,
    epochs=50,  # Уменьшим количество эпох для скорости
    batch_size=32,
...
# t-SNE с различными значениями перплексивности
...
# t-SNE 3D с лучшим значением перплексивности
best_perplexity = 35
...
print("   - Требует тщательной настройки архитектуры и параметров обучения")
...
print("   - Быстрый и стабильный метод")

print("\n4. СРАВНЕНИЕ:")
print("   - PCA: лучше для сохранения глобальной структуры")
print("   - t-SNE: лучше для визуализации локальных кластеров")
print("   - Autoencoder: универсальный метод, может учитывать нелинейности")
print("   - Для данного датасета все методы показывают хорошее разделение классов")

# Дополнительно: графики обучения
